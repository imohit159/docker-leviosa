...
import { useModifierKeyLabel } from "@/hooks/use-platform";
...
function CommandMenuTrigger({
  ...
  // Upstream hard-codes ⌘. The handler below already accepts Ctrl too, so on the Linux
  // and Windows boxes most Docker hosts run, the hint was simply telling people the
  // wrong key — and rendering a glyph their default font often has no outline for.
