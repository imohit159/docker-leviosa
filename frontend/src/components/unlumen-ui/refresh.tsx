...
export function RefreshButton({
  className,
  // Upstream defaults to a "neutral" variant that only exists in the Unlumen button;
  // this project's button is the shadcn base-nova one, where the equivalent is outline.
  variant = "outline",
  size,
  onRefresh,
  iconSize = 14,
